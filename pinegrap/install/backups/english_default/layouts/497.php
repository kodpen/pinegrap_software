                                                ...
                                                ?>
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input readonly type="number" name="quantity[<?=$item['id']?>]" id="quantity[<?=$item['id']?>]" class="form-control" style="min-width: 5em">
                                            ...
                                            <td class="text-right donation">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input readonly type="number" step="any" name="donations[<?=$item['id']?>]" id="donations[<?=$item['id']?>]" class="form-control" style="min-width: 6em">
...
<?=eval('?>' . generate_form_layout_content(array('page_id' => $page_id, 'form_type' => 'shipping', 'indent' => '                                                ')))?>
            ...
            <h5 class="uppercase text-right">Order Totals</h5>
...
<?=eval('?>' . generate_form_layout_content(array('page_id' => $page_id, 'form_type' => 'billing', 'indent' => '            ')))?>
    ...
    <p>
            This  <?=h($shopping_cart_label)?> request can be forwarded to anyone use this link:<br>
