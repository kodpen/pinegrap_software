...
<?php if (!$albums and !$photos): ?>
    	...
    	<div class="row">
    		<div class="col-sm-12">
                <p>Sorry, no photo albums or photos found in <strong> <?=h($album_name)?></strong> folder.</p>
			</div>
    	</div>
...
<?php else: ?>
    	...
    	<?php if ($albums): ?>
            <?php foreach($albums as $album): ?>
           	...
           	<div class="col-md-3 col-sm-6 masonry-item project" data-filter="<?=h($album['name'])?>">
                <div class="image-tile inner-title hover-reveal text-center">
                    <a href="<?=h($album['url'])?>">
                        ...
                        <div class="title">
                            ...
                            <span>(<?=number_format($album['number_of_photos'])?>
                            Photo<?php if ($album['number_of_photos'] > 1): ?>s<?php endif ?>)</span>
                        </div>
                    </a>
                </div>
            </div>
    	...
    	<?php if ($photos): ?>
            ...
            <div class="col-md-3 col-sm-6 masonry-item project" data-filter="Photos">
                <div class="image-tile inner-title hover-reveal text-center">
