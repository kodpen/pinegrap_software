          ...
          <form <?=$search_attributes?>>
                ...
                <?php if ($query != ''): ?>
                    <span class="input-group-btn" title="Clear">
                        <button type="submit" name="<?=$page_id?>_clear" style="width:3em;padding:0" class="btn btn-secondary btn-thin">
                            <i class="ti-close"></i>
                        </button>
                    </span>
                <?php endif ?>
        ...
        <?php if ($items): ?>
            ...
            <div class="masonry" style="position: relative; height: 966px;">
                ...
                <?php foreach($items as $item): ?>
                    ...
                    <div class="col-sm-6 masonry-item col-xs-12" style="position: absolute; left: 0px; top: 0px;">
