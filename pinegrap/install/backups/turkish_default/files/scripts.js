...
$(document).ready(function() { 
    ...
    var foundtry_card ='<div class="module widget-handle cart-widget-handle left"><div class="cart"><i class="ti-bag"></i><span class="label number">'+number+'</span><span class="title">AlÄ±ÅŸveriÅŸ Sepeti</span></div><div class="function"><div class="widget"><h6 class="title">AlÄ±ÅŸveriÅŸ Sepeti</h6><div class="cart-controls"><a class="btn btn-sm " href="'+url+'">Sepete Git</a><div class="list-inline pull-right"><span class="cart-total">Toplam:</span><span class="number">'+prices+'</span></div></div></div></div></div>';
