<div class="row mb12">
    ...
    <div class="col-sm-12">
        <h4>Bağışınız için teşekkürler!</h4>
    </div>
...
?>
    ...
    ?>
        <p class="text-muted">
            <small>
                * Bu tutar şu anki döviz kurumuz üzerinden <?=h($base_currency_name)?> üzerinden hesaplanmaktadır ve kesin masraflardan farklı olabilir (yukarıda <?=h($base_currency_name)?>'de gösterilmiştir).
            </small>
        </p>
    <?php endif ?>
...
<?php if ($auto_registration): ?>
    ...
    <p>Siparişlerinizi sitemizde görüntüleyebilmeniz için sizin için yeni bir hesap oluşturduk. Giriş bilgilerinizi aşağıda bulabilirsiniz.</p>
