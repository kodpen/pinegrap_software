...
<?php endif ?>
          ...
          <form <?=$search_attributes?>>
                ...
                <input type="text" name="<?=$page_id?>_query"
                    class="form-control" placeholder="Arama">
    ...
    <div class="col-sm-12">
        ...
        <?php else: // Otherwise no items were found, so output a message. ?>
            ...
            <?php if ($mode == 'browse'): ?>
                ...
                <h5>&Uuml;zg&uuml;n&uuml;z, bu &uuml;r&uuml;n grubunda &uuml;r&uuml;n bulunamad&#305;.</h5>

            <?php else: // Otherwise the mode is search ?>

        <h5>
		&Uuml;zg&uuml;n&uuml;z, <strong><?=h($query)?></strong> i&ccedil;eren &uuml;r&uuml;n bulunamad&#305;.</h5>
