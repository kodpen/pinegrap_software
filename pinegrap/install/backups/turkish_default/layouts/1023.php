...
<form <?=$attributes?>>
    ...
    <div class="form-group">
        <input type="text" name="314" id="314" class="form-control" placeholder="Konu">
    </div>
    </div>
    ...
    <!-- details -->
    <div class="form-group">
        <textarea name="315" id="315" placeholder="Size nasıl yardımcı olabiliriz?"></textarea>
    </div>
    </div>
    ...
    <?php if ($watcher_option): ?>
        ...
        <div class="checkbox">
            <label class="check-box">
                ...
                <span>Bir <?=h(mb_strtolower($comment_label))?> eklendiğinde bana bildir.</span>
            </label>
        </div>
        </div>
    <?php endif ?>
