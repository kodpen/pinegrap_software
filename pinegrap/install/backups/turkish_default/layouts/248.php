...
?>
    ...
    <p class="text-center lead">Lütfen alışveriş sepetinizi gözden geçirin ve siparişinize başlamak için 'Ödeme Yap' butonunu tıklayın.</p>
    ...
    <form <?=$attributes?>>
        ...
        ?>
                                                ...
                                                ?>
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="fieldset">
                                                            ...
                                                            <div class="legend">
																Hediye Kartı <?php if ($item['number_of_gift_cards'] > 1): ?>
                                                                    (<?=$quantity_number?>
            ...
            ?>
                <p class="text-muted">
                    <small>
                        Ödeme sırasında hesaplanacak 
                        <?php if ($taxable_items): ?>vergi<?php endif ?>
                        	<?php if ($shippable_items): ?>
                        		<?php if ($taxable_items): ?>ve <?php endif ?>
                        	nakliye<?php endif ?> 
                        ücretlerini içermez.
                    </small>
                </p>
            ...
            <?php if ($offline_payment_allowed): ?>
                ...
                <div class="checkbox">
                    <label class="check-box">
                        ...
                        Bu <?=h($shopping_cart_label)?> için çevrimdışı ödeme seçeneğine izin ver (ve uygulanacak güncellemeyi tıklayın).                    </label>
                </div>
                </div>
            <?php endif ?>
            ...
            <p class="help-block text-muted">
                <small>Toplamları güncellemek için <?=h($update_button_label)?> butonuna tıklayın veya toplamları güncellemek ve güvenli sunucumuzdaki siparişinizi tamamlamak için <?=h($checkout_button_label)?> butonuna tıklayın.</small>
            </p>         
        ...
        <?php if ($recurring_items): ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <h5 class="uppercase text-right">Yineleyen Toplamlar</h5>
    ...
    <p class="text-muted">
        <small>
            Bu <?=h($shopping_cart_label)?> Kaydedildi. Bu <?=h($shopping_cart_label)?> daha sonra tekrar görmek için lütfen bu bağlantıyı kullanın:<br>
