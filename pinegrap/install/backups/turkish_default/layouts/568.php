                    ...
                    <div class="form-group input-group">
                        ...
                        <?php if ($search_advanced): ?>
                            ...
                            <span
                                ...
                                title="<?php if ($search_advanced_expanded): ?>Kaldır<?php else: ?>Ekle<?php endif ?> Gelişmiş Arama"
                            >
...
?>
    ...
    <p>
        <strong>
			Sonuçları bulmak için 
            <?php if ($browse and $search): ?>
            göz atabilir veya arama yapabilirsiniz
            <?php elseif ($browse): ?>
            göz atabilirsiniz
            <?php else: ?>
...
?>
    ...
    ?>
        ...
        <p>
            <strong>
                <?=number_format($total_number_of_forms)?> sonuç bulundu.
        ...
        <nav>
            <ul class="pager">
                ...
                ?>
                    ...
                    <li>
                        <a href="<?=h($previous_page_url)?>">&laquo; Önceki</a>
                    </li>
                ...
                <li>
                    &nbsp;
                    Sayfa <?=number_format($page_number)?>/<?=number_format($number_of_pages)?>
                ...
                ?>
                    ...
                    <li>
                        <a href="<?=h($next_page_url)?>">Sonraki &raquo;</a>
                    </li>
