...
if (!$_POST) {
    ...
    echo
        ...
        <div id="content">
            ...
            <h1>Create Campaign Profile</h1>
            <div class="subheading" style="margin-bottom: 1.5em">Setup a Campaign to be created automatically when a certain action is completed (e.g. Visitor reserves Calendar Event).</div>
...
// Otherwise the form was just submitted, so process form.
    ...
    log_activity('campaign profile (' . $liveform->get_field_value('name') . ') was created', $_SESSION['sessionusername']);
    
    $liveform_view_email_campaign_profiles = new liveform('view_email_campaign_profiles');
    $liveform_view_email_campaign_profiles->add_notice('The campaign profile has been created.');
